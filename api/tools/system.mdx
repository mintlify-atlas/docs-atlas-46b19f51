...
- [Channel Tools](/api/tools/channel) - Conversation and delegation tools
- [Worker Tools](/api/tools/worker) - Task execution tools
- [Memory Tools](/api/tools/memory) - Knowledge storage and retrieval
