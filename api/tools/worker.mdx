...
<ResponseField name="base_dir" type="string">
...
<ParamField path="freshness" type="string">
...
```json
{
  "query": "FROM support@example.com SINCE 1-Jan-2024",
  "folder": "INBOX",
  "max_results": 5
}
```
...
- [Channel Tools](/api/tools/channel) - reply, branch, spawn_worker, route, send_file
- [Memory Tools](/api/tools/memory) - memory_save, memory_recall (branch only)
- [System Tools](/api/tools/system) - task management, worker inspection
